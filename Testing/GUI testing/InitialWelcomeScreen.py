...
import os.path
from camSetupPage import VideoCaptureSetupApp
...
class welcomeScreen:
    def __init__(self, root):
        ...
        self.middle_image = ImageTk.PhotoImage(Image.open(ConfigHandler.dirname+"images\\2.jpg").resize((200, 200)))
        self.right_image = ImageTk.PhotoImage(Image.open(ConfigHandler.dirname+"images\\3.jpg").resize((200, 200)))
    ...
    def open_video_capture_setup_page(self):
        ...
        app = VideoCaptureSetupApp(new_root)  # Initialize the VideoCaptureSetupApp with the new window
