...
def start_ocr():
    ocr = OCRProcessor(font_path="./Actual/arial.ttf",
                       text_detection_model_dir = os.path.dirname(ConfigHandler.dirname) + "/paddlex/official_models/PP-OCRv5_server_det",
                       text_recognition_model_dir = os.path.dirname(ConfigHandler.dirname) + "/paddlex/official_models/PP-OCRv5_server_rec",
