...
class OCRProcessor:
    '''
    # This init function is for PaddleOCR version lower than v3.0.0
    ...
    def perform_ocr_using_conditions(self, val, condition, frame_rgb, alt_name):
        ...
        # Code for PaddleOCR v2.9. To be removed once this script works properly with PaddleOCR v3.0.x
        '''
        ...
        # Modified Code for PaddleOCR v3.0.x
        ocr_data = result[0]
        ...
        # End of modified code for PaddleOCR v3.0.x
